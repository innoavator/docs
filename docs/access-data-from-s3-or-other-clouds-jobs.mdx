---
title: "Access data from S3 or other clouds"
...
The second approach is to provide your Job with a Role with the necessary permission through Service Accounts.
